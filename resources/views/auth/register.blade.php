...
<head>
    ...
    <title>Criar Conta - Carrinho Smart</title>
                ...
                <div class="card login-card">
                    <div class="card-body p-4">
                        <div class="text-center mb-4">
                            ...
                            <p class="text-muted mb-0">Criar nova conta</p>
                        </div>
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <button type="submit" class="btn btn-success btn-lg w-100 mb-3">Criar conta</button>

                            <div class="text-center">
                                <p class="mb-0">Já tem conta? <a href="{{ route('login') }}" class="text-success fw-bold">Entrar</a></p>
                            </div>
                        </form>
                    </div>
                </div>
